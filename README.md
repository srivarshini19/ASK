...
# Output Waveform - ASK
```
![WhatsApp Image 2025-10-27 at 13 23 32_7aa1aae6](https://github.com/user-attachments/assets/34f900b3-0be2-419a-a2ec-b8c1819e0c1d)
...
# Output waveform -FSK
```
![WhatsApp Image 2025-10-27 at 13 31 56_94efe5bb](https://github.com/user-attachments/assets/df96d917-4357-4aca-9d66-85e9633fde74)

```
# Results
```
Thus the Python program for the modulation and demodulation of ASK and FSK executed successfully.
```
